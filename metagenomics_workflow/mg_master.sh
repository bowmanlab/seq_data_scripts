...
## this is a major bottleneck, would be good place to use fram and gjoa.  However if you do so you'll
## overwrite the summary_stats.txt file, so this needs some work.
